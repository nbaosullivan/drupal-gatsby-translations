...
export type DrupalTranslation = Node & {
...
export type DrupalTranslationConnection = {
  totalCount: Scalars['Int'];
  edges: Array<DrupalTranslationEdge>;
  nodes: Array<DrupalTranslation>;
  pageInfo: PageInfo;
  distinct: Array<Scalars['String']>;
  group: Array<DrupalTranslationGroupConnection>;
};


export type DrupalTranslationConnectionDistinctArgs = {
  field: DrupalTranslationFieldsEnum;
};


export type DrupalTranslationConnectionGroupArgs = {
  skip?: Maybe<Scalars['Int']>;
  limit?: Maybe<Scalars['Int']>;
  field: DrupalTranslationFieldsEnum;
};

export type DrupalTranslationEdge = {
  next?: Maybe<DrupalTranslation>;
  node: DrupalTranslation;
  previous?: Maybe<DrupalTranslation>;
};

export type DrupalTranslationFieldsEnum = 
  | 'source'
  | 'translation'
  | 'langcode'
  | 'id'
...
export type DrupalTranslationFilterInput = {
...
export type DrupalTranslationGroupConnection = {
  totalCount: Scalars['Int'];
  edges: Array<DrupalTranslationEdge>;
  nodes: Array<DrupalTranslation>;
  pageInfo: PageInfo;
...
export type DrupalTranslationSortInput = {
  fields?: Maybe<Array<Maybe<DrupalTranslationFieldsEnum>>>;
  order?: Maybe<Array<Maybe<SortOrderEnum>>>;
};
...
export type Query = {
  ...
  drupalTranslation?: Maybe<DrupalTranslation>;
  allDrupalTranslation: DrupalTranslationConnection;
...
export type QueryDrupalTranslationArgs = {
  source?: Maybe<StringQueryOperatorInput>;
  translation?: Maybe<StringQueryOperatorInput>;
  langcode?: Maybe<StringQueryOperatorInput>;
  id?: Maybe<StringQueryOperatorInput>;
...
export type QueryAllDrupalTranslationArgs = {
  filter?: Maybe<DrupalTranslationFilterInput>;
  sort?: Maybe<DrupalTranslationSortInput>;
  skip?: Maybe<Scalars['Int']>;
  limit?: Maybe<Scalars['Int']>;
};
...
export type SitePageFieldsEnum = 
  ...
  | 'pluginCreator___pluginOptions___allowedLinkTypes'
  | 'pluginCreator___pluginOptions___basicAuth___username'
  | 'pluginCreator___pluginOptions___basicAuth___password'
...
export type SitePluginFieldsEnum = 
  ...
  | 'pluginOptions___allowedLinkTypes'
  | 'pluginOptions___basicAuth___username'
  | 'pluginOptions___basicAuth___password'
  ...
  | 'pluginOptions___i18nextOptions___react___useSuspense'
...
export type SitePluginPluginOptions = {
  ...
  allowedLinkTypes?: Maybe<Array<Maybe<Scalars['String']>>>;
  basicAuth?: Maybe<SitePluginPluginOptionsBasicAuth>;
...
export type SitePluginPluginOptionsBasicAuth = {
  username?: Maybe<Scalars['String']>;
  password?: Maybe<Scalars['String']>;
};

export type SitePluginPluginOptionsBasicAuthFilterInput = {
...
export type SitePluginPluginOptionsFilterInput = {
  ...
  allowedLinkTypes?: Maybe<StringQueryOperatorInput>;
  basicAuth?: Maybe<SitePluginPluginOptionsBasicAuthFilterInput>;
  translation?: Maybe<BooleanQueryOperatorInput>;
...
export type SitePluginPluginOptionsI18nextOptionsReact = {
  useSuspense?: Maybe<Scalars['Boolean']>;
};

export type SitePluginPluginOptionsI18nextOptionsReactFilterInput = {
  useSuspense?: Maybe<BooleanQueryOperatorInput>;
};
...
export type RecipeListingQueryVariables = Exact<{
  locale: Scalars['String'];
}>;


export type RecipeListingQuery = { allNodeRecipe: { edges: Array<{ node: (
        Pick<Node__Recipe, 'id' | 'langcode' | 'title'>
        & { path?: Maybe<Pick<Node__RecipePath, 'alias'>> }
      ) }> } };
...
export type RecipeDetailsQuery = { translations: { nodes: Array<(
      Pick<Node__Recipe, 'langcode'>
      & { path?: Maybe<Pick<Node__RecipePath, 'alias'>> }
    )> }, content?: Maybe<(
    Pick<Node__Recipe, 'title'>
    & { field_summary?: Maybe<Pick<Node__RecipeField_Summary, 'value'>>, field_recipe_instruction?: Maybe<Pick<Node__RecipeField_Recipe_Instruction, 'processed'>> }
  )> };

export type LocalizationSeoQueryQueryVariables = Exact<{ [key: string]: never; }>;


export type LocalizationSeoQueryQuery = { site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'siteUrl'>> }> };

export type LocalizationConfigQueryQueryVariables = Exact<{ [key: string]: never; }>;


export type LocalizationConfigQueryQuery = { themeI18N?: Maybe<(
    Pick<ThemeI18n, 'defaultLang'>
    & { config?: Maybe<Array<Maybe<Pick<Locale, 'code' | 'hrefLang' | 'dateFormat' | 'langDir' | 'localName' | 'name'>>>> }
  )> };
